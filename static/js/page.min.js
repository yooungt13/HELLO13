...
i[1]>=10&&i[2]>=3&&(e=document.querySelector("meta[name=viewport]")))){if(-1!==e.content.indexOf("user-scalable=no"))return!0;if(document.documentElement.scrollWidth<=window.outerWidth)return!0}return"none"===t.style.msTouchAction||"manipulation"===t.style.touchAction?!0:(o=+(/Firefox\/([0-9]+)/.exec(navigator.userAgent)||[,0])[1],o>=27&&(e=document.querySelector("meta[name=viewport]"),e&&(-1!==e.content.indexOf("user-scalable=no")||document.documentElement.scrollWidth<=window.outerWidth))?!0:"none"===t.style.touchAction||"manipulation"===t.style.touchAction?!0:!1)},t.attach=function(e,n){return new t(e,n)},"function"==typeof define&&"object"==typeof define.amd&&define.amd?define(function(){return t}):"undefined"!=typeof module&&module.exports?(module.exports=t.attach,module.exports.FastClick=t):window.FastClick=t}(),function(){function t(){var t=navigator.userAgent;return!!t.match(/.*Mobile.*/)}var e=$('<div class="backToTop icon"></div>');$("body").append(e),e.on("click",function(){document.body.scrollTop=0}),$(window).on("scroll",function(){$("body").scrollTop()>0?e.css("display","block"):e.css("display","none")}),$(".menu-icon").on("click",function(){var t=$(".menu");t.hasClass("menu-expand")?$(".menu").removeClass("menu-expand"):$(".menu").addClass("menu-expand")}),$(document).on("click",function(t){var e=$(".menu");e.hasClass("menu-expand")&&(e[0]==t.target||$.contains(e[0],t.target)||e.removeClass("menu-expand"))}),$(window).on("resize",function(t){$(window).width()<$("section").width()&&alert("再小就要压扁了。")}),$(document).ready(function(){if(t())FastClick.attach(document.body);else{var e=$('<a class="github-fork" href="http://github.com/yooungt13"><img src="http://s3.amazonaws.com/github/ribbons/forkme_right_red_aa0000.png" alt="Fork me on GitHub" /></a>');$("body").append(e)}})}();